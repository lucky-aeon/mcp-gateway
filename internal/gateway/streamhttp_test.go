...
func TestGlobalStreamHTTP_Initialize_CreatesSessionAndReturnsResult(t *testing.T) {
	...
	mockMgr.On("CreateProxySession", mock.Anything, mock.MatchedBy(func(n workspaces.NameArg) bool {
		return n.Workspace == workspaces.DefaultWorkspace
...
func TestGlobalStreamHTTP_NonInitialize_InvalidSessionReturns404(t *testing.T) {
	...
	})).Return((*sessions.Session)(nil), false).Once()
...
func TestGlobalStreamHTTP_Delete_ClosesSession(t *testing.T) {
	srv, mockMgr := createTestServerManager()
	mockMgr.On("CloseProxySession", mock.Anything, mock.MatchedBy(func(n workspaces.NameArg) bool {
...
func TestGlobalStreamHTTP_EventStream_DropsResponses(t *testing.T) {
	...
	go func() {
		...
		sess.SendEvent(sessions.SessionMsg{
			Event: "message",
